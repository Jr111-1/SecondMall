...
import com.lqf.fleamarket.controller.param.CommoStatusReq;
...
public class CommodityController extends BaseController{
    ...
    @PutMapping("/commodities/sell/{id}")
    public ResponseData changeSelling(@PathVariable long id) {
        this.commodityService.changeSelling(id);
        return new ResponseData(ResponseCode.SUCCSEE);
    }
